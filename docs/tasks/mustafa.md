...
## Сейчас
- 16:48 финальная проверка продукта без API: чистый clone с повторным backtest, browser/API smoke; README и интерфейс остаются у Ансара. Внешние LLM API отложены по решению Мустафы, ключ сохранён локально, DEMO_MODE=1.
