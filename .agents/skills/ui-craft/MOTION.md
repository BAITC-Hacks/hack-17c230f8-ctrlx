# Motion and interaction craft — original text

> Original text of Emil Kowalski's `emil-design-eng` skill (MIT, see `LICENSE-emil-design-eng.txt`; github.com/emilkowalski/skill @85e8e23). Changes: this header added, the "Initial Response" section removed.
