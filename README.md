...
| D — опубликованный план: D+1 обновлён, D+2 из t0 | 0,1536 |
...
Покрытие p10–p90: 81,6 % / 82,0 %; средняя ширина: 50,1 / 59,0 п.п. номинала. Это измеренные значения на этих периодах, не гарантия покрытия на новых данных.

**Сценарная стоимость отклонений.** Используются допущения расчёта: мощность 5 МВт, цена 22,68 ₸/кВт·ч и коэффициент 0,3 на каждое абсолютное отклонение заявки D+2. Освобождение в пределах ±5 % и взаимозачёт не моделируются. Это не фактический счёт станции и не измеренная экономия.
